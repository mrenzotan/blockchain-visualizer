      ...
      <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-1">
            {!isInvalid && (
              <div className="w-6 h-6 rounded-full bg-cyber-green/15 flex items-center justify-center">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-cyber-green">
            ...
            {isInvalid && (
              <div className="w-6 h-6 rounded-full bg-cyber-red/15 flex items-center justify-center">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-cyber-red">
        ...
        <div>
          <div className="flex items-center gap-1.5 mb-1">
            <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-500">
          ...
          {isEditing ? (
            <div className="flex gap-1.5">
              <input
                ...
                autoFocus
              />
              <button onClick={handleSaveEdit} className="text-xs px-2 py-1 bg-cyber-green/20 text-cyber-green rounded-lg hover:bg-cyber-green/30 transition-colors">OK</button>
              <button onClick={handleCancelEdit} className="text-xs px-2 py-1 bg-dark-500 text-slate-400 rounded-lg hover:bg-dark-700 transition-colors">X</button>
            </div>
          ) : (
            <p className="text-sm font-mono text-slate-200 break-all line-clamp-2 pl-0.5">{block.data}</p>
          )}
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <div className="flex items-center gap-1.5 mb-1">
              ...
              <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">Nonce</span>
            </div>
            <div className="bg-dark-700/50 rounded-lg px-3 py-1.5">
              <span className="text-sm font-mono text-cyber-green">{block.nonce}</span>
            </div>
          </div>
          <div>
            <div className="flex items-center gap-1.5 mb-1">
              ...
              <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">Difficulty</span>
            </div>
            <div className="bg-dark-700/50 rounded-lg px-3 py-1.5">
              <span className="text-sm font-mono text-cyber-amber">{block.hash ? block.hash.match(/^0*/)[0].length : '—'}</span>
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">Previous Hash</span>
          </div>
          <p
            ...
            onMouseLeave={() => setShowTooltip(null)}
          >
            {block.previousHash === '0' ? '0' : truncateHash(block.previousHash)}
        ...
        <div>
          <div className="flex items-center gap-1.5 mb-1">
            <HashIcon className="text-slate-500" />
            <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">Current Hash</span>
          </div>
          <p
